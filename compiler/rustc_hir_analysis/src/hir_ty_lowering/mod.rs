...
impl<'tcx> dyn HirTyLowerer<'tcx> + '_ {
    ...
    pub fn lower_generic_args_of_path_segment(
        ...
        if let Some(b) = item_segment.args().bindings.first() {
            prohibit_assoc_item_binding(self.tcx(), b, Some((def_id, item_segment, span)), false);
        }
        args
    }
    ...
    pub fn lower_generic_args_of_assoc_item(
        ...
        if let Some(b) = item_segment.args().bindings.first() {
            prohibit_assoc_item_binding(self.tcx(), b, Some((item_def_id, item_segment, span)), false);
        }
        args
    }
    ...
    fn lower_mono_trait_ref(
        ...
        if let Some(b) = trait_segment.args().bindings.first() {
            prohibit_assoc_item_binding(self.tcx(), b, Some((trait_def_id, trait_segment, span)), is_impl);
        }
    ...
    pub fn prohibit_generic_args<'a>(
        ...
        for segment in segments {
            ...
            if let Some(b) = segment.args().bindings.first() {
                return Err(prohibit_assoc_item_binding(self.tcx(), b, None, false));
            }
        }
